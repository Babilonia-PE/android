...
private const val ARRAY_SIZE = 11
...
class BezierView : View {
    ...
    private val shadowHeight = dipf(context, 6)
    ...
    private fun initializeViews() {
        ...
        mainPath = Path()
        shadowPath = Path()
        outerArray = Array(ARRAY_SIZE) { PointF() }
        innerArray = Array(ARRAY_SIZE) { PointF() }
        progressArray = Array(ARRAY_SIZE) { PointF() }
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        bezierOuterWidth = dipf(context, 76)
    ...
    private fun calculateInner() {
        ...
        innerArray[3] = PointF(bezierX - bezierInnerWidth / 4, 0 + extra / 4)
        innerArray[4] = PointF(bezierX, 0 + extra / 4)
        innerArray[5] = PointF(bezierX + bezierInnerWidth / 4, 0 + extra / 4)
