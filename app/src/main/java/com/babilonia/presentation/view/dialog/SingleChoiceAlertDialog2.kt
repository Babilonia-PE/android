...
import kotlinx.android.synthetic.main.dialog_alert_single_choice.*

class SingleChoiceAlertDialog2 private constructor(context: Context) : Dialog(context) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.dialog_alert_single_choice2)
    ...
    private fun setOnShowAction(onShow: (SingleChoiceAlertDialog2) -> Unit) {
        setOnShowListener {
            onShow(this)
        }
    }
    ...
    class Builder(private var context: Context) {
        ...
        fun setTitleText(text: String): SingleChoiceAlertDialog2.Builder {
            titleText = text
            return this
        }
        ...
        ): SingleChoiceAlertDialog2.Builder {
        ...
        fun setIsCancellable(isCancellable: Boolean): SingleChoiceAlertDialog2.Builder {
            isCustomDialogCancelable = isCancellable
            return this
        }

        fun setOnDismissListener(onDismiss: () -> Unit): SingleChoiceAlertDialog2.Builder {
            onDismissListener = onDismiss
            return this
        }

        fun build(): SingleChoiceAlertDialog2 {
            return SingleChoiceAlertDialog2(context).apply {
                setOnShowAction {
